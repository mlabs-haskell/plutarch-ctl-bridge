  ...
  inputs = {
    ...
    "cardano-transaction-lib" = pkgs.stdenv.mkDerivation {
      ...
      src = pkgs.fetchgit {
        ...
        sha256 = "0ywshgflwxw54rc8sk5j49bmd6apffcjfync040sh64qkvjrcfz3";
      };
      phases = "installPhase";
      installPhase = "ln -s $src $out";
    };
    ...
    "liqwid-ctl-extra" = pkgs.stdenv.mkDerivation {
      ...
      src = pkgs.fetchgit {
        ...
        rev = "1cfde97875244ea0a1477bd869ebb23e98cb3dd9";
        sha256 = "05k4d38cydhpcqrxcs7lcf4xzjivwmg8fimhkk2gz2kdmz4ayw0a";
      };
      phases = "installPhase";
      installPhase = "ln -s $src $out";
    };
